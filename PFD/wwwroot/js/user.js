...
var buttonElement = document.getElementById('face_recognition_button');
var video_validation = document.getElementById('video-validation');
                    ...
                    findBestMatch(blob, imageList)
                        .then((bestMatch) => {
                            if (bestMatch != undefined) {
                                // add ajax request code to backend to get login details
                                console.log(bestMatch);
                                console.log("Sending data to backend...");
                                /*$.ajax({
                                    url: '/User/LoginWithFace',
                                    type: 'POST',
                                    contentType: 'application/json',
                                    data: JSON.stringify({ loginName : bestMatch }),
                                    success: function () {
                                        console.log("test");
                                    },
